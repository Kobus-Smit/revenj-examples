...
namespace UseCase1.App.Service.Plugin.ServerCommand
{
    public class DeleteAllAndInsertDemoData : BaseServerCommand<string, string>
    {
        ...
        public override string Execute(string dummy)
        {
            ...
            context.Delete(context.Query<FormABC.Input>());
            context.Delete(context.Query<FormABC.Output>());
            context.Delete(context.Query<FormXYZ.Input>());
            context.Delete(context.Query<FormXYZ.Output>());
